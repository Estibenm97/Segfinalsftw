...
namespace CapaDatosPizzza
{
    public class BaseDeDatosSql: SqlBase
    {
        ...
        public SqlDataReader Login(string correo, string contraseña) { 
            ...
            SqlCommand sqlCmd = new SqlCommand("SPIniciarSesion", cn,tran);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            
            sqlCmd.Parameters.Add("@Usuario", SqlDbType.NVarChar,50).Value=correo;
        ...
        public void CambiarContraseña(string correo , string contraseñaNueva)
        {
            ...
            SqlConnection objCn = new SqlConnection(@"Data Source=LAPTOP-VT3DBHGB\SQLEXPRESS;Initial Catalog=Pizzza;Integrated Security=True");
        ...
        {
            SqlConnection cn = new SqlConnection(ConfigurationManager.AppSettings["CADENACONEXION"]);
            SqlCommand sqlCmd = new SqlCommand("uspActualizarP", cn);
            sqlCmd.CommandType = CommandType.StoredProcedure;
